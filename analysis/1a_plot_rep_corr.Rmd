...
# 5. Plot correlation heatmaps for ease of viewing

```{r heatmap}

# Read in Excel table that contains a copy of the correlation values calculated above

library(readxl)

rep_corr_r.df <- readxl::read_xlsx(path="/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/analysis/xlsx/rep_corr_df.xlsx", ) %>% 
  as.data.frame()
...
ggsave("rep_corr_summary.pdf", plot = rep_corr_summary.plot, path = "figures/1a_plot_rep_corr/", width = 30, height = 35, units = "cm")
ggsave("rep_corr_summary.png", plot = rep_corr_summary.plot, path = "figures/1a_plot_rep_corr/", width = 30, height = 35, units = "cm")
