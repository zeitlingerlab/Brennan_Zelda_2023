...
gd7_2to4_bw.list <- list(gd7_2to4_rep1 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/atac/individual/gd7_2to4_atac_1.bw",
                         gd7_2to4_rep2 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/atac/individual/gd7_2to4_atac_2.bw")
toll10b_2to4_bw.list <- list(toll10b_2to4_rep1 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/atac/individual/toll10b_2to4_atac_1.bw",
                         toll10b_2to4_rep2 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/atac/individual/toll10b_2to4_atac_2.bw")
...
gd7_mnase_bw.list <- list(gd7_mnase_rep1 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/mnase/individual/gd7_2to4_mono_mnase_1.bw",
                          gd7_mnase_rep2 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/mnase/individual/gd7_2to4_mono_mnase_2.bw")
toll10b_mnase_bw.list <- list(toll10b_mnase_rep1 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/mnase/individual/toll10b_2to4_mono_mnase_1.bw",
                          toll10b_mnase_rep2 = "/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/bw/dm6/mnase/individual/toll10b_2to4_mono_mnase_2.bw")
...
gd7_2to4_peaks <- import('/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/peaks/dm6/atac/combined/gd7_2to4_atac_combined_peaks.narrowPeak') %>% keepStandardChromosomes(pruning.mode="coarse")
toll10b_2to4_peaks <- import('/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zelda_and_Nucleosomes/Analysis/data/peaks/dm6/atac/combined/toll10b_2to4_atac_combined_peaks.narrowPeak') %>% keepStandardChromosomes(pruning.mode="coarse")
...
gd7_2to4_peaks$rep1signal <- regionSums(resize(gd7_2to4_peaks, 400, 'center'), gd7_2to4_bw.list$gd7_2to4_rep1)
gd7_2to4_peaks$rep2signal <- regionSums(resize(gd7_2to4_peaks, 400, 'center'), gd7_2to4_bw.list$gd7_2to4_rep2)

toll10b_2to4_peaks$rep1signal <- regionSums(resize(toll10b_2to4_peaks, 400, 'center'), toll10b_2to4_bw.list$toll10b_2to4_rep1)
toll10b_2to4_peaks$rep2signal <- regionSums(resize(toll10b_2to4_peaks, 400, 'center'), toll10b_2to4_bw.list$toll10b_2to4_rep2)
...
tss.gr$gd7_rep1signal <- regionSums(resize(tss.gr, 1000, 'center'), gd7_mnase_bw.list$gd7_mnase_rep1)
tss.gr$gd7_rep2signal <- regionSums(resize(tss.gr, 1000, 'center'), gd7_mnase_bw.list$gd7_mnase_rep2)
tss.gr$toll_rep1signal <- regionSums(resize(tss.gr, 1000, 'center'), toll10b_mnase_bw.list$toll10b_mnase_rep1)
tss.gr$toll_rep2signal <- regionSums(resize(tss.gr, 1000, 'center'), toll10b_mnase_bw.list$toll10b_mnase_rep2)
...
## Gd7 2-4
cor(as.data.frame(log(gd7_2to4_peaks$rep1signal+1)), as.data.frame(log(gd7_2to4_peaks$rep2signal+1)), method = "pearson")

## Toll10b 2-4 
cor(as.data.frame(log(toll10b_2to4_peaks$rep1signal+1)), as.data.frame(log(toll10b_2to4_peaks$rep2signal+1)), method = "pearson")
...
cor(as.data.frame(log(tss.gr$gd7_rep1signal+1)), as.data.frame(log(tss.gr$gd7_rep2signal+1)), method = "pearson")
cor(as.data.frame(log(tss.gr$toll_rep1signal+1)), as.data.frame(log(tss.gr$toll_rep2signal+1)), method = "pearson")
...
o_t1_1 <- plot_cor(orer_1to15_peaks, signal1 = orer_1to15_peaks$rep4signal, signal2 = orer_1to15_peaks$rep6signal, name = "Orer 1-1.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#31218C")
o_t1_2 <- plot_cor(orer_1to15_peaks, signal1 = orer_1to15_peaks$rep4signal, signal2 = orer_1to15_peaks$rep7signal, name = "Orer 1-1.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#31218C")
o_t1_3 <- plot_cor(orer_1to15_peaks, signal1 = orer_1to15_peaks$rep6signal, signal2 = orer_1to15_peaks$rep7signal, name = "Orer 1-1.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#31218C")
...
o_t2_1 <- plot_cor(orer_15to2_peaks, signal1 = orer_15to2_peaks$rep4signal, signal2 = orer_15to2_peaks$rep6signal, name = "Orer 1.5-2 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#232996")
o_t2_2 <- plot_cor(orer_15to2_peaks, signal1 = orer_15to2_peaks$rep4signal, signal2 = orer_15to2_peaks$rep7signal, name = "Orer 1.5-2 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#232996")
o_t2_3 <- plot_cor(orer_15to2_peaks, signal1 = orer_15to2_peaks$rep6signal, signal2 = orer_15to2_peaks$rep7signal, name = "Orer 1.5-2 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#232996")
...
o_t3_1 <- plot_cor(orer_2to25_peaks, signal1 = orer_2to25_peaks$rep4signal, signal2 = orer_2to25_peaks$rep6signal, name = "Orer 2-2.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#236E96")
o_t3_2 <- plot_cor(orer_2to25_peaks, signal1 = orer_2to25_peaks$rep4signal, signal2 = orer_2to25_peaks$rep7signal, name = "Orer 2-2.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#236E96")
o_t3_3 <- plot_cor(orer_2to25_peaks, signal1 = orer_2to25_peaks$rep6signal, signal2 = orer_2to25_peaks$rep7signal, name = "Orer 2-2.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#236E96")
...
o_t4_1 <- plot_cor(orer_25to3_peaks, signal1 = orer_25to3_peaks$rep4signal, signal2 = orer_25to3_peaks$rep6signal, name = "Orer 2.5-3 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#218C89")
o_t4_2 <- plot_cor(orer_25to3_peaks, signal1 = orer_25to3_peaks$rep4signal, signal2 = orer_25to3_peaks$rep7signal, name = "Orer 2.5-3 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#218C89")
o_t4_3 <- plot_cor(orer_25to3_peaks, signal1 = orer_25to3_peaks$rep6signal, signal2 = orer_25to3_peaks$rep7signal, name = "Orer 2.5-3 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#218C89")
...
g_t1_1 <- plot_cor(gd7_1to15_peaks, signal1 = gd7_1to15_peaks$rep3signal, signal2 = gd7_1to15_peaks$rep5signal, name = "Gd7 1-1.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#31218C")
g_t1_2 <- plot_cor(gd7_1to15_peaks, signal1 = gd7_1to15_peaks$rep3signal, signal2 = gd7_1to15_peaks$rep6signal, name = "Gd7 1-1.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#31218C")
g_t1_3 <- plot_cor(gd7_1to15_peaks, signal1 = gd7_1to15_peaks$rep5signal, signal2 = gd7_1to15_peaks$rep6signal, name = "Gd7 1-1.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#31218C")
...
g_t2_1 <- plot_cor(gd7_15to2_peaks, signal1 = gd7_15to2_peaks$rep3signal, signal2 = gd7_15to2_peaks$rep5signal, name = "Gd7 1.5-2 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#232996")
g_t2_2 <- plot_cor(gd7_15to2_peaks, signal1 = gd7_15to2_peaks$rep3signal, signal2 = gd7_15to2_peaks$rep6signal, name = "Gd7 1.5-2 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#232996")
g_t2_3 <- plot_cor(gd7_15to2_peaks, signal1 = gd7_15to2_peaks$rep5signal, signal2 = gd7_15to2_peaks$rep6signal, name = "Gd7 1.5-2 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#232996")
...
g_t3_1 <- plot_cor(gd7_2to25_peaks, signal1 = gd7_2to25_peaks$rep3signal, signal2 = gd7_2to25_peaks$rep5signal, name = "Gd7 2-2.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#236E96")
g_t3_2 <- plot_cor(gd7_2to25_peaks, signal1 = gd7_2to25_peaks$rep3signal, signal2 = gd7_2to25_peaks$rep6signal, name = "Gd7 2-2.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#236E96")
g_t3_3 <- plot_cor(gd7_2to25_peaks, signal1 = gd7_2to25_peaks$rep5signal, signal2 = gd7_2to25_peaks$rep6signal, name = "Gd7 2-2.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#236E96")
...
g_t4_1 <- plot_cor(gd7_25to3_peaks, signal1 = gd7_25to3_peaks$rep3signal, signal2 = gd7_25to3_peaks$rep5signal, name = "Gd7 2.5-3 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#218C89")
g_t4_2 <- plot_cor(gd7_25to3_peaks, signal1 = gd7_25to3_peaks$rep3signal, signal2 = gd7_25to3_peaks$rep6signal, name = "Gd7 2.5-3 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#218C89")
g_t4_3 <- plot_cor(gd7_25to3_peaks, signal1 = gd7_25to3_peaks$rep5signal, signal2 = gd7_25to3_peaks$rep6signal, name = "Gd7 2.5-3 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#218C89")
...
z_t1_1 <- plot_cor(zldrnai_1to15_peaks, signal1 = zldrnai_1to15_peaks$rep1signal, signal2 = zldrnai_1to15_peaks$rep2signal, name = "Zld- 1-1.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#31218C")
z_t1_2 <- plot_cor(zldrnai_1to15_peaks, signal1 = zldrnai_1to15_peaks$rep1signal, signal2 = zldrnai_1to15_peaks$rep3signal, name = "Zld- 1-1.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#31218C")
z_t1_3 <- plot_cor(zldrnai_1to15_peaks, signal1 = zldrnai_1to15_peaks$rep2signal, signal2 = zldrnai_1to15_peaks$rep3signal, name = "Zld- 1-1.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#31218C")
...
z_t2_1 <- plot_cor(zldrnai_15to2_peaks, signal1 = zldrnai_15to2_peaks$rep1signal, signal2 = zldrnai_15to2_peaks$rep2signal, name = "Zld- 1.5-2 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#232996")
z_t2_2 <- plot_cor(zldrnai_15to2_peaks, signal1 = zldrnai_15to2_peaks$rep1signal, signal2 = zldrnai_15to2_peaks$rep3signal, name = "Zld-i 1.5-2 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#232996")
z_t2_3 <- plot_cor(zldrnai_15to2_peaks, signal1 = zldrnai_15to2_peaks$rep2signal, signal2 = zldrnai_15to2_peaks$rep3signal, name = "Zld- 1.5-2 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#232996")
...
z_t3_1 <- plot_cor(zldrnai_2to25_peaks, signal1 = zldrnai_2to25_peaks$rep1signal, signal2 = zldrnai_2to25_peaks$rep2signal, name = "Zld- 2-2.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#236E96")
z_t3_2 <- plot_cor(zldrnai_2to25_peaks, signal1 = zldrnai_2to25_peaks$rep1signal, signal2 = zldrnai_2to25_peaks$rep3signal, name = "Zld- 2-2.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#236E96")
z_t3_3 <- plot_cor(zldrnai_2to25_peaks, signal1 = zldrnai_2to25_peaks$rep2signal, signal2 = zldrnai_2to25_peaks$rep3signal, name = "Zld- 2-2.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#236E96")
...
z_t4_1 <- plot_cor(zldrnai_25to3_peaks, signal1 = zldrnai_25to3_peaks$rep1signal, signal2 = zldrnai_25to3_peaks$rep2signal, name = "Zld- 2.5-3 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#218C89")
z_t4_2 <- plot_cor(zldrnai_25to3_peaks, signal1 = zldrnai_25to3_peaks$rep1signal, signal2 = zldrnai_25to3_peaks$rep3signal, name = "Zld- 2.5-3 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#218C89")
z_t4_3 <- plot_cor(zldrnai_25to3_peaks, signal1 = zldrnai_25to3_peaks$rep2signal, signal2 = zldrnai_25to3_peaks$rep3signal, name = "Zld- 2.5-3 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#218C89")
...
c_t3_1 <- plot_cor(cic6_2to25_peaks, signal1 = cic6_2to25_peaks$rep1signal, signal2 = cic6_2to25_peaks$rep2signal, name = "Cic6 2-2.5 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#236E96")
c_t3_2 <- plot_cor(cic6_2to25_peaks, signal1 = cic6_2to25_peaks$rep1signal, signal2 = cic6_2to25_peaks$rep3signal, name = "Cic6 2-2.5 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#236E96")
c_t3_3 <- plot_cor(cic6_2to25_peaks, signal1 = cic6_2to25_peaks$rep2signal, signal2 = cic6_2to25_peaks$rep3signal, name = "Cic6 2-2.5 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#236E96")
...
c_t4_1 <- plot_cor(cic6_25to3_peaks, signal1 = cic6_25to3_peaks$rep1signal, signal2 = cic6_25to3_peaks$rep2signal, name = "Cic6 2.5-3 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#218C89")
c_t4_2 <- plot_cor(cic6_25to3_peaks, signal1 = cic6_25to3_peaks$rep1signal, signal2 = cic6_25to3_peaks$rep3signal, name = "Cic6 2.5-3 h ATAC Replicate Correlation: rep 1 vs 3", colour = "#218C89")
c_t4_3 <- plot_cor(cic6_25to3_peaks, signal1 = cic6_25to3_peaks$rep2signal, signal2 = cic6_25to3_peaks$rep3signal, name = "Cic6 2.5-3 h ATAC Replicate Correlation: rep 2 vs 3", colour = "#218C89")
...
g_2to4 <- plot_cor(gd7_2to4_peaks, signal1 = gd7_2to4_peaks$rep1signal, signal2 = gd7_2to4_peaks$rep2signal, name = "Gd7 2-4 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#FCB13C")
ggsave("gd7_atac_2to4_corr_plots.pdf", plot = g_2to4, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
ggsave("dl_corr_plots.png", plot = g_2to4, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")

t_2to4 <- plot_cor(toll10b_2to4_peaks, signal1 = toll10b_2to4_peaks$rep1signal, signal2 = toll10b_2to4_peaks$rep2signal, name = "Toll10b 2-4 h ATAC Replicate Correlation: rep 1 vs 2", colour = "#3535A8")
ggsave("toll10b_atac_2to4_corr_plots.pdf", plot = t_2to4, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
ggsave("toll10b_atac_2to4_corr_plots.png", plot = t_2to4, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
...
g_mnase <- plot_cor(tss.gr, signal1 = tss.gr$gd7_rep1signal, signal2 = tss.gr$gd7_rep2signal, name = "Gd7 MNase Replicate Correlation: rep 1 vs 2", colour = "#FCB13C")
ggsave("gd7_mnase_corr_plots.pdf", plot = g_mnase, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
ggsave("gd7_mnase_corr_plots.png", plot = g_mnase, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
t_mnase <- plot_cor(tss.gr, signal1 = tss.gr$toll_rep1signal, signal2 = tss.gr$toll_rep2signal, name = "Toll10b MNase Replicate Correlation: rep 1 vs 2", colour = "#3535A8")
ggsave("toll10b_mnase_corr_plots.pdf", plot = t_mnase, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
ggsave("toll10b_mnase_corr_plots.png", plot = t_mnase, path = "figures/1a_plot_rep_corr/", width = 16, height = 25, units = "cm")
