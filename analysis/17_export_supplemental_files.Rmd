...
filtered_islands.df <- as.data.frame(filtered_islands.gr)
colnames(filtered_islands.df) <- c("chr", "start", "end", "width", "strand", "island_id", "island_content", "island_content_ordered", "island_content_unique", "number_motifs_in_island")
